...
@injectMainStore
@observer
class CompositeKeyEntityEditComponent extends React.Component<
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CompositeKeyEntityManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={CompositeKeyEntityManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompositeKeyEntityManagement.PATH}>
...
export default injectIntl(CompositeKeyEntityEditComponent);
