...
@injectMainStore
@observer
class EmbeddedEntityEditComponent extends React.Component<
...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === EmbeddedEntityManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={EmbeddedEntityManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={EmbeddedEntityManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new EmbeddedTestEntity());
    } else {
...
export default injectIntl(EmbeddedEntityEditComponent);
